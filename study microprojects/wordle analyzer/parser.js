...
reParserTrash = /<\/strong>.*?<strong>/gi
...
reParserCapitals = /^[А-ЯЁ]/;
dictionaryFive = dictionaryFive.filter(el => reParserCapitals.test(el) === false);
