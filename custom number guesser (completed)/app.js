    ...
    if (document.querySelector('#inputField').value === "") {
        ...
        if (triesLeft === 5) {
            ...
            if (numberInput === numberToGuess) {
                // document.querySelector('#UItext').textContent = `You've guessed right, it was ${numberToGuess}!`;
                // document.querySelector('#enter').textContent = `Play again`;
                UIchange(`You've guessed right, it was ${numberToGuess}!`, `Play again`);
                triesLeft = 0;
            ...
            if (numberInput != numberToGuess) {
                ...
                // document.querySelector('#UItext').textContent = `Wrong, try again. You have ${triesLeft} attempts left`;
            ...
            if (numberInput != numberToGuess) {
                // document.querySelector('#UItext').textContent = `You lost! Wanna play again?`;
                // document.querySelector('#enter').textContent = `Play again`;
            ...
            // document.querySelector('#enter').textContent = `Guess!`;
            // document.querySelector('#UItext').textContent = "Enter a number from 1 to 10";
