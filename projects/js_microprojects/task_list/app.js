...
function drawTask(taskToDraw) {
  ...
  if (localtasks != []) {
    ...
    document
      ...
      .parentElement.parentElement.parentElement.lastElementChild.lastElementChild.lastElementChild.addEventListener(
        "click",
        deleteLocalTask
      );
...
function addTask(e) {
  ...
  if (localtasks.indexOf(taskText) != -1) {
...
function filterTasks(e) {
  ...
  console.log(
    liSelected.firstElementChild.firstElementChild.firstElementChild.textContent.indexOf(
      filterText
    )
  );
  for (
    let i = 0;
    i < document.querySelector(".tasks-ul").children.length;
    i++
  ) {
    if (
      liSelected.firstElementChild.firstElementChild.firstElementChild.textContent.indexOf(
      ...
      liSelected.style.display = "block";
    }
